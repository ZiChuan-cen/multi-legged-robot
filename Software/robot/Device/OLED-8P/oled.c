...
{		
  ...
  /* GPIO Ports Clock Enable */
	...
	GPIO_SetBits(OLED_CS1_Group,OLED_rs_GPIO);
	GPIO_SetBits(OLED_rs_Group,OLED_sid_GPIO);
	GPIO_SetBits(OLED_sid_Group,OLED_sclk_GPIO);
	GPIO_SetBits(OLED_sclk_Group,OLED_sclk_GPIO);
	GPIO_SetBits(OLED_CS_Group,OLED_CS_GPIO);

  GPIO_InitStruct.GPIO_Pin = OLED_CS1_GPIO;
  GPIO_InitStruct.GPIO_Mode = GPIO_Mode_Out_PP;
  GPIO_InitStruct.GPIO_Speed = GPIO_Speed_2MHz;
  GPIO_Init(OLED_CS1_Group, &GPIO_InitStruct);

  GPIO_InitStruct.GPIO_Pin = OLED_rs_GPIO;
  GPIO_Init(OLED_rs_Group, &GPIO_InitStruct);

  GPIO_InitStruct.GPIO_Pin = OLED_sid_GPIO;
  GPIO_Init(OLED_sid_Group, &GPIO_InitStruct);

  GPIO_InitStruct.GPIO_Pin = OLED_sclk_GPIO;
  GPIO_Init(OLED_sclk_Group, &GPIO_InitStruct);

  GPIO_InitStruct.GPIO_Pin = OLED_CS_GPIO;
  GPIO_Init(OLED_CS_Group, &GPIO_InitStruct);
	
  GPIO_InitStruct.GPIO_Pin = OLED_OUT_GPIO;
  GPIO_Init(OLED_OUT_Group, &GPIO_InitStruct);
...
ulong  fontaddr=0;
void display_GB2312_string(unsigned char   y,unsigned char   x, char  *text)
{
	uchar i= 0;
...
void Display_Byte(uchar y,uchar x,uchar Num) 
{
  switch(Num) 
	{
		case 0 : display_GB2312_string(y,x,(char *)"0"); break;
		case 1 : display_GB2312_string(y,x,(char *)"1"); break;
		case 2 : display_GB2312_string(y,x,(char *)"2"); break;
		case 3 : display_GB2312_string(y,x,(char *)"3"); break;
		case 4 : display_GB2312_string(y,x,(char *)"4"); break;
		case 5 : display_GB2312_string(y,x,(char *)"5"); break;
		case 6 : display_GB2312_string(y,x,(char *)"6"); break;
		case 7 : display_GB2312_string(y,x,(char *)"7"); break;
		case 8 : display_GB2312_string(y,x,(char *)"8"); break;
		case 9 : display_GB2312_string(y,x,(char *)"9"); break;
	}
}
